 ...
 */
public class ActivityFragment extends RefreshBaseFragment implements FootUpdate.LoadMore {
    @Bind(R.id.listView)
    ...
    protected class ActivityAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view = mInflater.inflate(R.layout.fragment_activity_list_item, null);
            return view;
        }
    }
