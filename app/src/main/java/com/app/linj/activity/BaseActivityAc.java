 ...
 */
public class BaseActivityAc extends FragmentActivity {
    ...
    public void ShowToast(final int resId) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                // TODO Auto-generated method stub
                if (mToast == null) {
                    mToast = Toast.makeText(BaseActivityAc.this.getApplicationContext(), resId,
                            Toast.LENGTH_LONG);
                } else {
    ...
    public void updateUserLocation(){
        if(CustomApplcation.lastPoint!=null){
            ...
            if(!saveLatitude.equals(newLat)|| !saveLongtitude.equals(newLong)){//只有位置有变化就更新当前位置，达到实时更新的目的
                UserBean u = (UserBean) userManager.getCurrentUser(UserBean.class);
