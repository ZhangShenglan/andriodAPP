...
import com.app.linj.adapter.HuifulistAdapter;
 ...
 */
public class HuifulistActivity extends Activity implements View.OnClickListener,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.commentbtn:
                ...
                progress.show();
                UserBean user = BmobUser.getCurrentUser(HuifulistActivity.this,
                        UserBean.class);
